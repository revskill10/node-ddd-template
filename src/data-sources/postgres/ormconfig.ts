...
import { entities } from 'src/data-sources/postgres/entities';
import { migrations } from 'src/data-sources/postgres/migrations';
...
export const OrmConfig = {
    ...
    subscribers: [],
    cli: {
        entitiesDir: 'src/data-sources/entities',
        migrationsDir: 'src/data-sources/migrations'
    },
