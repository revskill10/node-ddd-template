...
export const SERVICE_NAME = process.env.SERVICE_NAME || 'xendit-kyc-service';
...
export const PGPORT = Number(process.env.PGPORT) || 5433;
...
// Kafka
export const { KAFKA_BROKERS, KAFKA_SASL_MECHANISM, KAFKA_SASL_PASSWORD, KAFKA_SASL_USERNAME } = process.env;
export const NUX_KYC_DUMMY_TOPIC =
    process.env.NUX_KYC_DUMMY_TOPIC || `${APP_ENV}.${APP_MODE}.public.examples.sampleapp.node.roundrobin`;
